...
/**
 * Created by randomlocks on 6/6/2016.
 */
public class AVLoadingIndicatorView extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mIndicatorId = a.getInt(R.styleable.AVLoadingIndicatorView_indicator, Pacman);
    ...
    private void applyIndicator() {
        switch (mIndicatorId) {
            ...
            case Pacman:
                mIndicatorController = new PacmanLoadingIndicator();
                break;
